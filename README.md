# AetherCell
code for "AetherCell: A generative engine for virtual cell perturbation and in vivo drug discovery"
...
### Train model
```
python train_aethercell.py
```

### Infer profile
```
python prediction_aethercell.py
```
(uploaded a example infer_weight.pt for inference)
